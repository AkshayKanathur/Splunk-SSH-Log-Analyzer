...
A cybersecurity project focused on **SSH log analysis** using **Splunk SIEM**.  
This lab demonstrates how to monitor SSH activity, detect anomalies, analyze failed login attempts, and investigate suspicious IPs through Splunk searches and visualizations.  

---

## 🎯 Objective  
To build a **Splunk-based analysis workflow** that helps in understanding SSH behavior, login trends, and possible brute-force attempts.
